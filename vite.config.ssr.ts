...
export default defineConfig({
  ...
  ssr: {
    ...
    noExternal: ['react', 'invariant', 'js-yaml', 'react-router', 'swiper/react',  'scheduler', 'front-matter', 'lucide-react', 'shallowequal', 'react-dom', 'react-fast-compare', 'react-router-dom', '@remix-run/router', 'react-helmet-async'],
  },
})